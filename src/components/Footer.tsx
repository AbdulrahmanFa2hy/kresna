...
const SocialIcon = ({ children, href = "#" }: { children: React.ReactNode; href?: string }) => (
  <a href={href} className="w-8 h-8 md:w-9 md:h-9 bg-[#1a1a1a] rounded-[0.5rem] md:rounded-[0.6rem] flex items-center justify-center text-white hover:bg-black transition-colors focus:outline-none focus:ring-2 focus:ring-white/50 shadow-lg">
    {children}
  </a>
);
  ...
  return (
    <footer className="relative w-full min-h-screen bg-[#fdfdfd] flex flex-col justify-end py-20 md:py-24 lg:py-28 pb-20 md:pb-24 lg:pb-32 overflow-hidden">
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-6 lg:px-8">
        <div className="w-full z-10 flex flex-col md:flex-row gap-3 mb-2">
          {/* Left Blue Box */}
          <div 
            className="w-full md:w-[42%] lg:w-[37%] xl:w-[32%] aspect-[1/0.85] md:aspect-auto md:h-[400px] lg:h-[500px] rounded-[1.5rem] bg-cover bg-center shadow-inner p-8 lg:p-10 flex flex-col justify-between overflow-hidden relative"
            style={{ backgroundImage: "url('https://res.cloudinary.com/deplilexq/image/upload/q_auto/f_auto/v1777293431/Gemini_Generated_Image_sahvsdsahvsdsahv_rnnxmk.jpg')" }}
          >
            {/* Top Logo Area */}
            <div className="flex items-center gap-3 relative z-10">
              ...
              />
              <span className="text-white text-4xl font-semibold tracking-tight">Kresna</span>
            </div>

            {/* Bottom Area */}
            <div className="relative z-10 mt-auto pt-8">
              <h3 className="text-white text-[20px] md:text-[22px] lg:text-[24px] font-medium leading-[1.2] mb-6">
                Smarter sales automation,<br/>
                <span className="text-white/60">powered by AI.</span>
              </h3>
              <div className="flex items-center justify-between mt-auto">
                <span className="text-white/80 font-handwriting text-[1.1rem] md:text-[1.3rem] tracking-wide rotate-[-3deg] inline-block">
                  Stay in touch!
                </span>
          ...
          {/* Right Light Box */}
          <div className="w-full md:flex-1 aspect-[1/0.85] md:aspect-auto md:h-[400px] lg:h-[500px] rounded-[1.5rem] bg-[#f5f5f5] p-8 lg:p-10 flex flex-col justify-between relative">
            {/* Top Section */}
              ...
              <div className="flex gap-12 lg:gap-20">
                <div className="flex flex-col">
                  ...
                  <ul className="flex flex-col gap-y-3">
                    <li><a href="#" className="text-[#1a1a1a] text-[15px] font-semibold hover:text-blue-600 transition-colors">How it works</a></li>
                    <li><a href="#" className="text-[#1a1a1a] text-[15px] font-semibold hover:text-blue-600 transition-colors">Features</a></li>
                    <li><a href="#" className="text-[#1a1a1a] text-[15px] font-semibold hover:text-blue-600 transition-colors">Pricing</a></li>
                    <li><a href="#" className="text-[#1a1a1a] text-[15px] font-semibold hover:text-blue-600 transition-colors">Testimonials</a></li>
                    <li><a href="#" className="text-[#1a1a1a] text-[15px] font-semibold hover:text-blue-600 transition-colors">FAQ</a></li>
                  </ul>
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <ul className="flex flex-col gap-y-3">
                    <li><a href="#" className="text-[#1a1a1a] text-[15px] font-semibold hover:text-blue-600 transition-colors">Blog</a></li>
                    <li><a href="#" className="text-[#1a1a1a] text-[15px] font-semibold hover:text-blue-600 transition-colors">About</a></li>
                    <li><a href="#" className="text-[#1a1a1a] text-[15px] font-semibold hover:text-blue-600 transition-colors">Terms and Condition</a></li>
                    <li><a href="#" className="text-[#1a1a1a] text-[15px] font-semibold hover:text-blue-600 transition-colors">Privacy Policy</a></li>
                  </ul>
                </div>
              </div>

              <div className="absolute -top-5 right-10 lg:-top-8 lg:right-6 xl:right-20 z-20">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mt-16 md:mt-auto gap-8 md:gap-0">
              ...
              <div className="flex flex-col items-start w-full md:w-auto">
                ...
                <div className="flex items-center bg-white rounded-[1rem] md:rounded-[1.25rem] p-1.5 shadow-[0_2px_15px_-5px_rgba(0,0,0,0.05)] w-full max-w-[320px]">
                  ...
                  />
                  <button className="bg-[#1a1a1a] hover:bg-black text-[#f0f0f0] text-[13px] md:text-[14px] font-semibold px-3.5 py-2.5 rounded-[0.75rem] md:rounded-[1rem] transition-colors whitespace-nowrap shadow-[0_10px_15px_-3px_rgba(0,0,0,0.2)]">
                    Subscribe
                  </button>
                </div>
              </div>
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-6 lg:px-8">
        <div className="w-full flex justify-center items-end -mt-2 relative z-0 pointer-events-none select-none" style={{ marginBottom: '-6vw' }}>
